...
const Resume = () => {
  ...
  const frontendSkills = [
    ...
    { name: 'CSS', percent: 90, className: 'css' },
    { name: 'JavaScript', percent: 50, className: 'javascript' },
    { name: 'React', percent: 60, className: 'react' },
    { name: 'vite', percent: 30, className: 'vite' }
  ];
  const backendSkills = [
    { name: 'PHP', percent: 40, className: 'php' },
    { name: 'MongoDB', percent: 50, className: 'mongodb' },
    { name: 'Node.js', percent: 40, className: 'nodejs' },
    { name: 'Express', percent: 50, className: 'express' },
  ];
  const education = [
    {
      date: '2019 – March 2024 (Expected)',
      degree: 'High School Diploma',
      institution: 'Salvador Arollado Memorial High School'
    },
    {
      date: '2015 – April 2019',
      degree: 'Elementary Achiever',
      ...
      <section className="resume-content">
        ...
        <div className="resume-section hero-section">
          ...
          <div className="hero-main-info">
            ...
            <p className="summary">
              Highly skilled and motivated web developer with 2 years of experience in
              front-end and back-end development. Middle knowledge and hardworking student of HTML, CSS,
              JavaScript, and PHP, with a focus on creating responsive and user-friendly websites.
            </p>
          </div>
        ...
        <div className="resume-section skills-section-resume">
          <h2 className="skills-heading"><i className="fas fa-tools"></i> Skill Proficiency Overview</h2>
          <br />
